...
private:
    MessageCommandRequest BuildSessionCommandRequest(const std::shared_ptr<IChatSession>& session,
                                                     short msg_id,
                                                     const std::string& msg_data) const;
    void SendSessionCommandResult(const std::shared_ptr<IChatSession>& session,
