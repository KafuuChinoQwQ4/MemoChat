...
{
    memolog::SpanScope span("ChatService.NotifyAddFriend",
                            "CLIENT",
                            {{"rpc.system", "grpc"},
                             {"rpc.service", "ChatService"},
                             {"rpc.method", "NotifyAddFriend"},
                             {"peer_service", server_ip}});
    AddFriendRsp rsp;
    Defer defer(
        [&rsp, &req]()
        {
...
{
    memolog::SpanScope span("ChatService.NotifyAuthFriend",
                            "CLIENT",
                            {{"rpc.system", "grpc"},
                             {"rpc.service", "ChatService"},
                             {"rpc.method", "NotifyAuthFriend"},
                             {"peer_service", server_ip}});
    AuthFriendRsp rsp;
    rsp.set_error(ErrorCodes::Success);
...
TextChatMsgRsp ChatGrpcClient::NotifyTextChatMsg(std::string server_ip,
                                                 ...
                                                 const memochat::json::JsonValue& rtvalue)
{
    memolog::SpanScope span("ChatService.NotifyTextChatMsg",
                            "CLIENT",
                            {{"rpc.system", "grpc"},
                             {"rpc.service", "ChatService"},
                             {"rpc.method", "NotifyTextChatMsg"},
                             {"peer_service", server_ip}});
...
{
    memolog::SpanScope span("ChatService.NotifyGroupMessage",
                            "CLIENT",
                            {{"rpc.system", "grpc"},
                             {"rpc.service", "ChatService"},
                             {"rpc.method", "NotifyGroupMessage"},
                             {"peer_service", server_ip}});
...
{
    memolog::SpanScope span("ChatService.NotifyGroupEvent",
                            "CLIENT",
                            {{"rpc.system", "grpc"},
                             {"rpc.service", "ChatService"},
                             {"rpc.method", "NotifyGroupEvent"},
                             {"peer_service", server_ip}});
...
{
    memolog::SpanScope span("ChatService.NotifyGroupMemberBatch",
                            "CLIENT",
                            {{"rpc.system", "grpc"},
                             {"rpc.service", "ChatService"},
                             {"rpc.method", "NotifyGroupMemberBatch"},
                             {"peer_service", server_ip}});
