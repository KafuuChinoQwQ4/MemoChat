...
extern "C" R18_EXPORT const char* r18_plugin_call(const char* request_json)
{
    ...
    {
        return CopyJson(
            R"({"error":0,"data":{"id":"mock.native","name":"Native Mock Source","version":"1.0.0","adult":true}})");
    }
    if (req.find("\"method\":\"source.search\"") != std::string::npos)
    {
        return CopyJson(
            R"({"error":0,"data":{"items":[{"source_id":"mock.native","comic_id":"native-1","title":"Native Mock Comic","subtitle":"Returned by C ABI plugin","cover":""}]}})");
    }
    if (req.find("\"method\":\"comic.detail\"") != std::string::npos)
    {
        return CopyJson(
            R"({"error":0,"data":{"source_id":"mock.native","comic_id":"native-1","title":"Native Mock Comic","description":"Mock detail from native plugin","chapters":[{"source_id":"mock.native","comic_id":"native-1","chapter_id":"native-1-ch1","title":"Chapter 1","order":1}]}})");
    }
    if (req.find("\"method\":\"chapter.pages\"") != std::string::npos)
    {
        return CopyJson(
            R"({"error":0,"data":{"source_id":"mock.native","chapter_id":"native-1-ch1","pages":[{"index":1,"image_id":"native-1","url":""}]}})");
    }
