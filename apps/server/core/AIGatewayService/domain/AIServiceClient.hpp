...
public:
    ...
    memochat::json::JsonValue AgentTaskGet(int32_t uid, const std::string& task_id);

    memochat::json::JsonValue AgentTaskCancel(int32_t uid, const std::string& task_id);

    memochat::json::JsonValue AgentTaskResume(int32_t uid, const std::string& task_id);
