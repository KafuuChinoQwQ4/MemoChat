...
> C++ 实现的 AI 服务节点：承接网关转发的 AI 请求，对接 AIOrchestrator/LLM，并落库会话消息与智能日志。
...
| `AIServiceJsonDtos.cpp` | AIServer 稳定 JSON DTO 与 protobuf 响应映射实现。 |
| `AIServiceJsonDtos.hpp` | AIServer 稳定 JSON DTO 与 protobuf 响应映射声明。 |
