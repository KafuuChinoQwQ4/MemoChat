...
void H1MomentsServiceRoutes::RegisterRoutes(H1LogicSystem& logic)
{
                   ...
                   const std::string& trace_id)
                {
                    ...
                    if (memochat::json::glaze_is_array(items_json))
                    {
                        for (size_t idx = 0; idx < items_json.size(); ++idx)
                        {
                            ...
                            MomentItemInfo item;
                            item.media_type =
                                memochat::json::glaze_safe_get<std::string>(item_json, "media_type", "text");
                    ...
                    const std::string raw_content =
                        memochat::json::glaze_safe_get<std::string>(src_root, "content", "");
    ...
    logic.RegPost("/api/moments/list",
                  [](std::shared_ptr<H1Connection> connection)
                  {
                      return H1JsonSupport::HandleJsonPost(
                          connection,
                             ...
                             const std::string& trace_id)
                          {
                              ...
                              int64_t last_moment_id =
                                  memochat::json::glaze_safe_get<int64_t>(src_root, "last_moment_id", 0LL);
    ...
    logic.RegPost("/api/moments/detail",
                  [](std::shared_ptr<H1Connection> connection)
                  {
                      return H1JsonSupport::HandleJsonPost(
                          connection,
    ...
    logic.RegPost("/api/moments/delete",
                  [](std::shared_ptr<H1Connection> connection)
                  {
                      return H1JsonSupport::HandleJsonPost(
                          connection,
    ...
    logic.RegPost("/api/moments/like",
                  [](std::shared_ptr<H1Connection> connection)
                  {
                      return H1JsonSupport::HandleJsonPost(
                          connection,
    ...
    logic.RegPost("/api/moments/comment",
                  [](std::shared_ptr<H1Connection> connection)
                  {
                      return H1JsonSupport::HandleJsonPost(
                          connection,
                             ...
                             const std::string& trace_id)
                          {
                              ...
                              if (delete_mode)
                              {
                                  ...
                                  {
                                      memolog::LogWarn(
                                          "gate.h1.moments.comment.delete",
    ...
    logic.RegPost("/api/moments/comment/list",
                  [](std::shared_ptr<H1Connection> connection)
                  {
                      return H1JsonSupport::HandleJsonPost(
                          connection,
                             ...
                             const std::string& trace_id)
                          {
                              ...
                              int64_t last_comment_id =
                                  memochat::json::glaze_safe_get<int64_t>(src_root, "last_comment_id", 0LL);
                              int limit = memochat::json::glaze_safe_get<int>(src_root, "limit", 20);
                              if (limit <= 0)
                                  limit = 20;
                              if (limit > 50)
                              ...
                              bool has_more = false;
                              if (!PostgresMgr::GetInstance()
                                       ->GetMomentComments(moment_id, last_comment_id, limit, comments, has_more))
                              {
                                  root["error"] = ErrorCodes::RPCFailed;
                                  return true;
                              }
    ...
    logic.RegPost("/api/moments/comment/like",
                  [](std::shared_ptr<H1Connection> connection)
                  {
                      return H1JsonSupport::HandleJsonPost(
                          connection,
