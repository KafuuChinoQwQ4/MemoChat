...
SearchInfo::SearchInfo(int uid, QString name, QString nick, QString desc, int sex, QString icon, QString userId)
    : _uid(uid)
    , _user_id(userId)
    , _name(name)
    , _nick(nick)
...
AddFriendApply::AddFriendApply(int from_uid,
                               QString name,
                               QString desc,
                               QString icon,
                               QString nick,
