...
enum ReqId
{
    ...
    ID_DISSOLVE_GROUP_REQ = 1110,
    ID_DISSOLVE_GROUP_RSP = 1111,
    ID_CALL_START = 1086,
    ID_CALL_ACCEPT = 1087,
    ID_CALL_REJECT = 1088,
    ID_CALL_CANCEL = 1089,
    ...
    ID_MOMENTS_LIST = 1100,
    ID_MOMENTS_PUBLISH = 1101,
    ID_MOMENTS_DELETE = 1102,
    ID_MOMENTS_LIKE = 1103,
    ID_MOMENTS_COMMENT = 1104,
    ID_MOMENTS_DETAIL = 1105,
    ID_MOMENTS_COMMENT_LIST = 1106,
    ID_MOMENTS_COMMENT_LIKE = 1107,

    // AI Agent
    ID_AI_CHAT = 1200,
    ID_AI_SMART = 1201,
    ID_AI_HISTORY = 1202,
    ID_AI_SESSION_CREATE = 1203,
    ID_AI_SESSION_LIST = 1204,
    ID_AI_SESSION_DELETE = 1205,
    ID_AI_MODEL_LIST = 1206,
    ID_AI_KB_UPLOAD = 1207,
    ID_AI_KB_SEARCH = 1208,
    ID_AI_KB_LIST = 1209,
    ID_AI_KB_DELETE = 1210,
    ID_AI_MODEL_API_REGISTER = 1211,
    ID_AI_MEMORY_LIST = 1212,
    ID_AI_MEMORY_CREATE = 1213,
    ID_AI_MEMORY_DELETE = 1214,
    ID_AI_TASK_LIST = 1215,
