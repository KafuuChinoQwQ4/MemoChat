...
class Live2DAsset : public QObject
{
    ...
    Q_PROPERTY(
        QString expressionDirectory READ expressionDirectory WRITE setExpressionDirectory NOTIFY assetInputsChanged)
...
public:
    ...
    QString vtubeMappingFile() const
    {
        return _resolved_vtube_mapping_file.isEmpty() ? _vtube_mapping_file : _resolved_vtube_mapping_file;
    }
    QString physicsFile() const
    {
        return _physics_file;
    }
    QString poseFile() const
    {
        return _pose_file;
    }
    QString userDataFile() const
    {
        return _user_data_file;
    }
    QString packageChecksum() const
    {
        return _package_checksum;
    }
    ...
    int referencedFileCount() const
    {
        return _referenced_file_count;
    }
    QVariantList actionItems() const
    {
