...
> Live2D 头像的 OpenGL 渲染管线与 QML 渲染项实现。
...
| `Live2DRenderItem.cpp` | QML 场景中的 Live2D 渲染项实现 |
| `Live2DRenderItem.h` | QML 渲染项的接口定义 |
| `Live2DRenderPathResolver.cpp` | 渲染资源路径解析实现 |
| `Live2DRenderPathResolver.h` | 渲染资源路径解析的接口定义 |
| `Live2DRenderer.h` | 渲染器抽象基类/通用接口定义 |
