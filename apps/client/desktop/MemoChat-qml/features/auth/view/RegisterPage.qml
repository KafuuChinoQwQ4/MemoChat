...
Rectangle {
    ...
    property bool registerCodeCoolingDown: auth.registerCodeCooldownSeconds > 0
    property bool registerCodeUnavailable: auth.busy
                ...
                RowLayout {
                    ...
                    Item {
                        ...
                        Image {
                            ...
                            scale: confirmEyeArea.pressed ? 0.96 : (confirmEyeArea.containsMouse ? 1.02 : 1.0)
                        ...
                        Rectangle {
                            anchors.centerIn: confirmEyeIcon
                            width: 28
                            height: 28
                            radius: 14
                            color: confirmEyeArea.pressed ? Qt.rgba(0.35, 0.61, 0.90, 0.24)
                                                          : confirmEyeArea.containsMouse ? Qt.rgba(0.35, 0.61, 0.90, 0.14)
                                                                                    : "transparent"
                ...
                RowLayout {
                    ...
                    GlassButton {
                        ...
                        text: registerRoot.registerCodeCoolingDown
                              ? auth.registerCodeCooldownSeconds + "s"
                              : "获取"
                        textPixelSize: 14
        ...
        Item {
            ColumnLayout {
                ...
                Label {
                    ...
                    color: "#566074"
                    font.pixelSize: 14
                    text: "注册成功，" + auth.registerCountdown + " s后返回登录"
                }
