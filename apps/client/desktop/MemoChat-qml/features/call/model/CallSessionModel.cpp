...
bool CallSessionModel::visible() const
{
    return _visible;
}
bool CallSessionModel::incoming() const
{
    return _incoming;
}
bool CallSessionModel::active() const
{
    return _active;
}
bool CallSessionModel::tokenReady() const
{
    return _token_ready;
}
QString CallSessionModel::callId() const
{
    return _call_id;
}
QString CallSessionModel::callType() const
{
    return _call_type;
}
QString CallSessionModel::peerName() const
{
    return _peer_name;
}
QString CallSessionModel::peerIcon() const
{
    return _peer_icon;
}
QString CallSessionModel::stateText() const
{
    return _state_text;
}
QString CallSessionModel::roomName() const
{
    return _room_name;
}
QString CallSessionModel::livekitUrl() const
{
    return _livekit_url;
}
QString CallSessionModel::mediaLaunchJson() const
{
    return _media_launch_json;
}
QString CallSessionModel::mediaStatusText() const
{
    return _media_status_text;
}
int CallSessionModel::elapsedSeconds() const
{
    return _elapsed_seconds;
}
bool CallSessionModel::muted() const
{
    return _muted;
}
bool CallSessionModel::cameraEnabled() const
{
    return _camera_enabled;
}

void CallSessionModel::startOutgoing(const QString& callId,
...
void CallSessionModel::startIncoming(const QString& callId,
                                     const QString& callType,
                                     const QString& peerName,
                                     const QString& peerIcon,
                                     const QString& stateText,
...
void CallSessionModel::markAccepted(const QString& stateText,
