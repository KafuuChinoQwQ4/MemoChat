...
{
public:
    static void syncHistoryCursor(const ChatMessageModel& messageModel, qint64& beforeTs, QString& beforeMsgId);
    ...
    static void updatePrivatePreview(FriendListModel& chatListModel,
                                     ...
                                     qint64 lastMsgTs);
    static void clearPrivateUnread(FriendListModel& chatListModel, FriendListModel& dialogListModel, int peerUid);
    ...
    static void updateGroupPreview(FriendListModel& groupListModel,
                                   ...
                                   qint64 lastMsgTs);
    static void
    clearGroupUnreadAndMention(FriendListModel& dialogListModel, QHash<int, int>& mentionMap, int dialogUid);
