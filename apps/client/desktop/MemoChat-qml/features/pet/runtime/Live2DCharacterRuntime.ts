export const pathDirectory = (path: unknown): string => {
    const p = String(path || "")
...
export const optionalFileLabel = (label: string, value: unknown): string => {
    return label + " " + (String(value || "").length > 0 ? "已识别" : "未声明")
}

export const actionKindLabel = (kind: string): string => {
    if (kind === "motion")
        return "动作"
    if (kind === "expression")
        return "表情"
...
export const assetStatusTone = (status: string): string => {
    if (status === "ready")
        return "green"
    if (status === "empty")
        return "blue"
...
export const defaultVoicePath = (voiceDirectory: unknown, defaultVoice: unknown): string => {
...
export const languageCode = (languageText: string): string => {
    if (languageText === "日语")
        return "ja-JP"
    if (languageText === "英语")
        return "en-US"
...
export const voiceTrainingStatusLabel = (status: string, stage: string): string => {
...
export interface NormalizedVoiceTrainingState {
    status: string
    stage: string
    progress: number
    message: string
...
export const normalizedVoiceTrainingState = (state: VoiceTrainingState): NormalizedVoiceTrainingState => {
    const next: NormalizedVoiceTrainingState = {
...
export interface PromptValues {
    ...
    idleMotion: unknown
    speakingMotion: unknown
    fallbackExpression: unknown
    speechRules: unknown
    catchphrases: unknown
    forbiddenRules: unknown
}

export const promptPreview = (values: PromptValues): string => {
...
export interface AgentSettings {
    ...
    modelRoot: unknown
    modelJson: unknown
    motionDirectory: unknown
    expressionDirectory: unknown
    ...
    voiceSpeed: unknown
    lipSyncSensitivity: unknown
    voiceLipSyncEnabled: unknown
    emotionSoundEnabled: unknown
    idleMotionEnabled: unknown
    gazeFollowEnabled: unknown
    memoryEnabled: unknown
    interruptEnabled: unknown
    cameraEnabled: unknown
    cloudVisionEnabled: unknown
    autoStartPetOnClientStart: unknown
    voiceTrainingConsent: unknown
    voiceTrainingConsentScope: unknown
    voiceTrainingJobId: unknown
    voiceTrainingStatus: unknown
    voiceTrainingStage: unknown
    voiceTrainingProgress: unknown
    voiceTrainingArtifactPath: unknown
    voiceTrainingMessage: unknown
    toneIndex: unknown
    responseLengthIndex: unknown
    languageIndex: unknown
    statusText?: unknown
}
...
export const applySettingsToDraft = (
    target: AgentDraft,
    settings: AgentSettings,
    toneCombo: ComboBox,
    responseLengthCombo: ComboBox,
...
export const storeDraftToSettings = (
    settings: AgentSettings,
    source: AgentDraft,
    toneIndex: unknown,
    responseLengthIndex: unknown,
