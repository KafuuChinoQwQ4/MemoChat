...
export const ENDPOINTS = {
  ...
  r18VideoResolve:   "/api/r18/video/resolve",
  ...
  r18AccountBrowserImportStart:  "/api/r18/account/browser-import/start",
  r18AccountBrowserImportStatus: "/api/r18/account/browser-import/status",
  r18AccountSessionImport:       "/api/r18/account/session/import",
