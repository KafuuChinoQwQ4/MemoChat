...
function senderStatusText(state) {
    if (state === "sending")
        return "发送中";
    if (state === "failed")
        return "发送失败";
...
export function MessageBubble({ message, showAvatar = true, stacked = false }) {
    ...
    const avatarSlot = (_jsx("div", { style: {
        ...
        }, children: _jsx(Avatar, { src: messageAvatarSrc, name: senderName, size: AVATAR_SIZE }) }));
    const bubble = (_jsxs("div", { style: {
            maxWidth: isSelf ? "min(56%, 440px)" : "min(64%, 500px)",
            display: "flex",
            flexDirection: "column",
            alignItems: isSelf ? "flex-end" : "flex-start",
        }, children: [!isSelf && showAvatar && senderName && (_jsx("div", { style: {
                    maxWidth: "100%",
                    margin: "0 0 4px",
                    fontSize: 11,
                    lineHeight: 1.2,
                    ...
                    whiteSpace: "nowrap",
                }, children: senderName })), _jsx("div", { style: {
                    maxWidth: "100%",
                    minHeight: 30,
                    padding: "5px 8px",
                    borderRadius: isSelf
                ...
                }, children: isRevoked ? (_jsx("span", { style: { color: "var(--text-disabled)", fontStyle: "italic", fontSize: 13 }, children: "\u6D88\u606F\u5DF2\u64A4\u56DE" })) : (message.content) }), statusText ? (_jsx("div", { style: {
                    marginTop: 4,
                    fontSize: 11,
                    lineHeight: 1.2,
    ...
    return (_jsx("div", { style: {
            ...
            padding: "0 14px",
        }, children: isSelf ? (_jsxs(_Fragment, { children: [bubble, avatarSlot] })) : (_jsxs(_Fragment, { children: [avatarSlot, bubble] })) }));
}
