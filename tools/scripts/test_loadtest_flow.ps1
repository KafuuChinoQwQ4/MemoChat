# Test full flow with @loadtest.local synthetic email
$ErrorActionPreference = "Continue"

# Step 1: Get verify code
Write-Host "=== Step 1: Get verify code ==="
try {
    $body = '{"email":"testuser123@loadtest.local"}'
...
try {
    $body = '{"email":"testuser123@loadtest.local","user":"testuser","passwd":"123456","confirm":"123456","icon":"","varifycode":"123456","sex":0}'
