...
readonly -a MEMOCHAT_RUNTIME_SERVICE_TOPOLOGY=(
    ...
    "aigateway|AIGatewayService1|AIGatewayServer|AIGatewayServer|AIGatewayService/aigateway.ini|AIGatewayService-1|8093||aigatewayservice1|8093||../../artifacts/logs/services/AIGatewayService1|AIGatewayService1|memochat"
    "mediagateway|MediaGatewayService1|MediaGatewayServer|MediaGatewayServer|MediaService/mediagateway.ini|MediaGatewayService-1|8094||mediagatewayservice1|8094||../../artifacts/logs/services/MediaGatewayService1|MediaGatewayService1|memochat"
    "momentsgateway|MomentsGatewayService1|MomentsGatewayServer|MomentsGatewayServer|MomentsService/momentsgateway.ini|MomentsGatewayService-1|8099||momentsgatewayservice1|8099||../../artifacts/logs/services/MomentsGatewayService1|MomentsGatewayService1|memochat"
    "callgateway|CallGatewayService1|CallGatewayServer|CallGatewayServer|CallService/callgateway.ini|CallGatewayService-1|8097||callgatewayservice1|8097||../../artifacts/logs/services/CallGatewayService1|CallGatewayService1|memochat"
    "r18gateway|R18GatewayService1|R18GatewayServer|R18GatewayServer|R18Service/r18gateway.ini|R18GatewayService-1|8098||r18gatewayservice1|8098||../../artifacts/logs/services/R18GatewayService1|R18GatewayService1|memochat"
    "register|RegisterService1|RegisterServer|RegisterServer|RegisterService/register.ini|RegisterService-1|8101||registerservice1|8101||../../artifacts/logs/services/RegisterService1|RegisterService1|memochat"
    "login|LoginService1|LoginServer|LoginServer|LoginService/login.ini|LoginService-1|8102||loginservice1|8102||../../artifacts/logs/services/LoginService1|LoginService1|memochat"
