...
REF_AUDIO="${MEMOCHAT_PET_SOVITS_REFERENCE_AUDIO:-$HOST_DATA_DIR/refs/reference.wav}"
PROMPT_TEXT="${MEMOCHAT_PET_SOVITS_PROMPT_TEXT:-}"
PROMPT_TEXT_FILE="${MEMOCHAT_PET_SOVITS_PROMPT_TEXT_FILE:-$HOST_DATA_DIR/refs/reference.txt}"
...
export GPT_SOVITS_REF_AUDIO="$REF_AUDIO"
