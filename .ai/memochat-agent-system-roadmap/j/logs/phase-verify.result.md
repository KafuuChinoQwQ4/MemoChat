...
```powershell
.venv\Scripts\python.exe -m py_compile harness\handoffs\service.py harness\contracts.py harness\runtime\container.py api\agent_router.py schemas\api.py tests\test_harness_structure.py
