...
```powershell
.venv\Scripts\python.exe -m py_compile harness\skills\specs.py harness\skills\registry.py harness\orchestration\planner.py harness\orchestration\agent_service.py harness\runtime\container.py api\agent_router.py schemas\api.py tests\test_harness_structure.py
