...
class MemoChatQmlCoreLayoutTests(unittest.TestCase):
    ...
    def test_qml_shell_runtime_helpers_are_registered(self):
        ...
        r18_runtime = (QML_DIR / "features/r18/runtime/R18ShellRuntime.js").read_text(encoding="utf-8")
        agent_pane = (QML_DIR / "features/agent/view/AgentPane.qml").read_text(encoding="utf-8")
        agent_runtime = (QML_DIR / "features/agent/runtime/AgentPaneRuntime.js").read_text(encoding="utf-8")

        self.assertIn("features/r18/runtime/R18ShellRuntime.js", qrc)
        self.assertIn("features/agent/runtime/AgentPaneRuntime.js", qrc)
        self.assertIn('import "../runtime/R18ShellRuntime.js" as R18ShellRuntime', r18_shell)
    ...
    def test_heavy_app_controller_session_concerns_are_split(self):
        ...
        self.assertIn("std::optional<ChatTransportKind> parseDesktopEndpointTransportKind", auth_login)
        self.assertIn("return std::nullopt;", auth_login)
        self.assertIn("if (!endpointTransport)", auth_login)
