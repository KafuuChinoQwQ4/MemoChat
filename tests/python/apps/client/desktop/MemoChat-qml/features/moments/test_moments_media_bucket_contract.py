...
class MomentsMediaBucketContractTests(unittest.TestCase):
    ...
    def test_s3_storage_routes_moment_uploads_to_dedicated_bucket(self):
        source = read(SERVER_CORE / "GateServerCore/S3MediaStorage.cpp")
        header = read(SERVER_CORE / "GateServerCore/S3MediaStorage.h")
    ...
    def test_gate_configs_define_moments_bucket(self):
        config_paths = [
            ...
            SERVER_CORE / "GateServerHttp1.1/config.ini",
            SERVER_CORE / "GateServerHttp2/config.ini",
    ...
    def test_moment_image_uses_image_upload_limit(self):
        ...
        gate_h1 = read(SERVER_CORE / "GateServer/MediaHttpService.cpp")
        gate_shared = read(SERVER_CORE / "GateServerCore/Http2MediaSupport.cpp")
