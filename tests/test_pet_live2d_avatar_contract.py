...
PET_AVATAR_PATH_UTILS_H = CLIENT_DIR / "features/pet/assets/PetAvatarPathUtils.h"
PET_AVATAR_PATH_UTILS_CPP = CLIENT_DIR / "features/pet/assets/PetAvatarPathUtils.cpp"
