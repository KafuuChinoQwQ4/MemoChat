...
description: Use when planning or executing MemoChat implementation tasks that may need Controller-led worker/subagent delegation, code ownership boundaries, or local-only concurrency records.
---
