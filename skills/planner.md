...
- 准确构建/测试/运行时命令
- 数据准备和清理规则
- 失败处理，尤其是 Arch/WSL 端口冲突、Docker 集成和 Docker 健康状态
...
- Arch Docker 绑定数据：`/data/docker-data/memochat`。
...
- 观测：Grafana `3000`、Prometheus `9090`、InfluxDB `8086`、Loki `3100`、Tempo `3200`、OTel `4317/4318/9411/9464`、cAdvisor `8088`。
