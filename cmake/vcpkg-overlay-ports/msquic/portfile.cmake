...
if("0-rtt" IN_LIST FEATURES)
    ...
    # The vendored OpenSSL otherwise embeds vcpkg's temporary build directory
    # as MODULESDIR in libmsquic. Use the distro path so release artifacts do
    # not disclose the build host and retain a stable provider lookup fallback.
    vcpkg_replace_string(
        "${QUIC_SOURCE_PATH}/submodules/openssl3/Configurations/unix-Makefile.tmpl"
