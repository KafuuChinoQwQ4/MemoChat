...
# OpenSSL publishes its compiler flags and install-derived lookup directories
# through OpenSSL_version(). Keep the real compiler prefix maps, but omit those
# host-specific arguments from the generated buildinfo and use runtime paths
# provided by the pinned Ubuntu x86_64 backend image.
vcpkg_replace_string(
    "${SOURCE_PATH}/Configurations/unix-Makefile.tmpl"
...
vcpkg_replace_string(
    "${SOURCE_PATH}/util/mkbuildinf.pl"
    [=[my $cflags = join(' ', @ARGV);]=]
    [=[my $cflags = join(' ', @ARGV);
$cflags =~ s{(?:^|\s)-f(?:file|macro)-prefix-map=\S+}{}g;
$cflags =~ s{^\s+|\s+$}{}g;
$cflags =~ s{\s+}{ }g;]=]
)
