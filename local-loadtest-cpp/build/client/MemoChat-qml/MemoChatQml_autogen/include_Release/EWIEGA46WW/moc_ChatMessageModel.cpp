...
#include "../../../../../../../client/MemoChat-qml/ChatMessageModel.h"
...
void ChatMessageModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ChatMessageModel::*)();
            if (_q_method_type _q_method = &ChatMessageModel::countChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatMessageModel::countChanged()
{
