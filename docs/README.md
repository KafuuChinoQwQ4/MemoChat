...
本目录保存可版本化的项目开发文档。`docs/resume/` 和 `docs/superpowers/` 属于个人资料或工作流生成物，按 `.gitignore` 继续忽略；正式开发文档放在本目录的 `dev/`、`architecture/`、`contracts/`、`debug/` 和 `adr/`。
...
| 排障案例 | [debug/README.md](debug/README.md) | 复盘本地运行时、传输、服务崩溃等问题 |
