...
> 项目文档目录，含版本化开发文档、架构概览、跨模块契约、ADR，以及本地简历/工作流生成资料。
...
| 文件 | 作用概括 |
| --- | --- |
| `README.md` | 开发文档总入口和放置规则 |
| `database-architecture-overview.html` | 数据库架构图（交互式 HTML） |
| `project-architecture-overview.html` | 项目整体架构概览（交互式 HTML） |
