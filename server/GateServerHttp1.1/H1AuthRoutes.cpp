...
void H1AuthService::RegisterRoutes(H1LogicSystem& logic) {
    logic.RegPost("/get_varifycode", [](std::shared_ptr<H1Connection> connection) {
        Json::Value root;
        Json::Value src_root;
        if (!H1JsonSupport::ParseJsonBody(connection, root, src_root)) {
...
void H1CallServiceRoutes::RegisterRoutes(H1LogicSystem& logic)
{
    logic.RegPost("/api/call/start", [](std::shared_ptr<H1Connection> connection) {
        return H1JsonSupport::HandleJsonPost(connection, [](const Json::Value& src_root, Json::Value& root, const std::string& trace_id) {
    ...
    logic.RegGet("/api/call/token", [](std::shared_ptr<H1Connection> connection) {
    ...
    logic.RegPost("/api/call/token", [](std::shared_ptr<H1Connection> connection) {
        return H1JsonSupport::HandleJsonPost(connection, [](const Json::Value& src_root, Json::Value& root, const std::string& trace_id) {
